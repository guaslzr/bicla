        ...
        <div class="container">
                  ...
                  <div class="" id="accordion">
                      ...
                      <div class="card ">
                          <div class="card-header">
                              <h4 class="card-header">
                                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"><i>¿Cuánto tiempo llevará construir mi bicicleta?</i></a>
                              </h4>
                          </div>
                      ...
                      <div class="card ">
                          <div class="card-header">
                              <h4 class="card-header">
                                  <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTen"><i>Si les envío mi marco, ¿puedes construirme una bicicleta?</i></a>
                              </h4>
                          </div>
                      ...
                      <div class="card ">
                          <div class="card-header">
                              <h4 class="card-header">
                                  <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven"><i>¿Puedo poner un cesto en mi bicicleta?</i></a>
                              </h4>
                          </div>
                      ...
                      <div class="card ">
                          <div class="card-header">
                              <h4 class="card-header">
                                  <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><i>Tengo mi propio juego de ruedas / sillín /  de una bicicleta vieja, ¿puedes construirme una bicicleta pero usar mis piezas existentes?</i></a>
                              </h4>
                          </div>
                      ...
                      <div class="card ">
                          <div class="card-header">
                              <h4 class="card-header">
                                  <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree"><i>¿Dónde están hechas las bicicletas?</i></a>
                              </h4>
                          </div>
                      ...
                      <div class="card ">
                          <div class="card-header">
                              <h4 class="card-header">
                                  <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive"><i>¿Que mantenimiento tendré que hacerle a mi bicicleta?</i></a>
                              </h4>
                          </div>
                      ...
                      <div class="card ">
                          <div class="card-header">
                              <h4 class="card-header">
                                  <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix"><i>¿Existe un límite de peso para las bicicletas?</i></a>
                              </h4>
                          </div>
                      ...
                      <div class="card ">
                          <div class="card-header">
                              <h4 class="card-header">
                                  <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour"><i>¿Qué método de pago puedo elegir?</i></a>
                              </h4>
                          </div>
